...
CREATE UNIQUE INDEX `auth_account_provider_account_unique` ON `auth_account` (`provider_id`, `account_id`);
--> statement-breakpoint
CREATE INDEX `auth_account_user_index` ON `auth_account` (`user_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `auth_passkey_credential_unique` ON `auth_passkey` (`credential_id`);
--> statement-breakpoint
CREATE INDEX `auth_passkey_user_index` ON `auth_passkey` (`user_id`);
--> statement-breakpoint
